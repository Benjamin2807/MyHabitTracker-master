    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                EditText samplePersonEditTextView = (EditText) findViewById(R.id.editText2);
                String value = samplePersonEditTextView.getText().toString();

                EditText editText = (EditText) findViewById(R.id.editText3);
                int val = Integer.parseInt(samplePersonEditTextView.getText().toString());

                dbHelper = new HabitTrackerDBHelper(this);
                insertHabit(samplePersonEditTextView,editText);
